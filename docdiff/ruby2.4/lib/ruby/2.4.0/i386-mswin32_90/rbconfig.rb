...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.4.0/i386-mswin32_90")
  ...
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/Linkout/clipdiff/docdiff/ruby2.4")
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["ruby_install_name"] = "ruby"
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "msvcr90-ruby240"
  CONFIG["SHELL"] = "$(COMSPEC)"
  CONFIG["BUILD_FILE_SEPARATOR"] = "\\"
  CONFIG["PATH_SEPARATOR"] = ";"
  CONFIG["CFLAGS"] = "-MD -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -O2sy-  -Zm600"
  CONFIG["WERRORFLAG"] = "-WX"
  CONFIG["DEFS"] = ""
  CONFIG["CPPFLAGS"] = " -D_WIN32_WINNT=0x0600  "
  CONFIG["CXXFLAGS"] = "-MD -Zi -W2 -wd4100 -wd4127 -wd4210 -wd4214 -wd4255 -wd4574  -wd4668 -wd4710 -wd4711 -wd4820 -wd4996  -we4028 -we4142 -O2sy-  -Zm600"
  CONFIG["FFLAGS"] = ""
  CONFIG["LDFLAGS"] = "-incremental:no -debug -opt:ref -opt:icf"
  CONFIG["LIBS"] = "user32.lib advapi32.lib shell32.lib ws2_32.lib iphlpapi.lib imagehlp.lib shlwapi.lib "
  ...
  CONFIG["build"] = "i686-pc-mswin32_90"
  CONFIG["build_alias"] = "i686-mswin32_90"
  CONFIG["build_cpu"] = "i686"
  CONFIG["build_vendor"] = "pc"
  CONFIG["build_os"] = "mswin32_90"
  CONFIG["host"] = "i686-pc-mswin32_90"
  CONFIG["host_alias"] = "i686-mswin32_90"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host_vendor"] = "pc"
  CONFIG["host_os"] = "mswin32_90"
  CONFIG["target"] = "i386-pc-mswin32_90"
  CONFIG["target_alias"] = "i386-mswin32_90"
  CONFIG["target_cpu"] = "i386"
  CONFIG["target_vendor"] = "pc"
  CONFIG["target_os"] = "mswin32_90"
  CONFIG["NULLCMD"] = ":"
  CONFIG["CC"] = "cl -nologo"
  ...
  CONFIG["arch"] = "i386-mswin32_90"
  CONFIG["sitearch"] = "i386-msvcr90"
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=C:\\Linkout\\clipdiff\\docdiff\\ruby2.4"
